...
Dieses Programm soll anschließend in das - in \nameref{para:python} geschriebenen - Kommunikations-Modul integriert und von jenem verwendet werden.
\\
